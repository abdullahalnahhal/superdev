...
return [
    ...
    '{attribute} cannot be blank.' => 'حقل {attribute} لا يمكن تركه فارغًا.',
    '{attribute} is invalid.' => 'حقل {attribute} غير صالح.',
    '{attribute} is not a valid URL.' => 'حقل {attribute} ليس بعنوان صحيح.',
    '{attribute} is not a valid email address.' => 'حقل {attribute} ليس ببريد إلكتروني صحيح.',
    '{attribute} must be "{requiredValue}".' => 'حقل {attribute} يجب أن يكون "{requiredValue}".',
    '{attribute} must be a number.' => 'حقل {attribute} يجب أن يكون رقمًا',
    '{attribute} must be a string.' => 'حقل {attribute} يجب أن يكون كلمات',
    '{attribute} must be an integer.' => 'حقل {attribute} يجب أن يكون رقمًا صحيحًا',
